...
function activate(context) {
    const userPath = (0, path_1.getUserPath)(context);
    const disposableWatchingSettings = vscode.commands.registerCommand("sync-profiles.watchSettings", () => {
        const disposeWatchDirectory = (0, file_1.watchDirectory)(userPath, (event, filePath) => {
            if (event === "add") {
